...
/**
 * Allows to test everything with use of 5 jobs od different periods updating
 * tables of different priorities by EDF Partitioned global scheduling and
 * Prioritized EDF local schedulers.
 * @author Grzegorz Mrukwa
 */
public class FiveJobsGlobalEdfLocalEdf extends TestScenario {
    ...
    public String getName() {
        return "FiveJobsGlobalEdfLocalEdf";
    }
    ...
    public String getDescription() {
        return " * Allows to test everything with use of 5 jobs od different"
                + " periods updating\n * tables of different priorities by EDF"
                + " Partitioned global scheduling and\n * Prioritized EDF local"
                + " schedulers.";
    }
    ...
    public void run() {
        ...
        GlobalScheduler scheduler = new EdfPartitioned(
